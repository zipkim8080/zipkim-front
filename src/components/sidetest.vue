...
const myPageModalOpen = () => {
  myPageModal.value = !myPageModal.value;
};
</script>
...
<template>
  <div class="modal-sidebar">
    ...
    <div class="menu">
      <!-- 각 메뉴 항목들 -->
      <button @click="myPageModalOpen" class="menu-item">
        <span class="text">내 정보</span>
        <div class="modal-wrap" v-show="myPageModal">
          <div class="modal-container" @click.stop>
            <mypage @close="myPageModalOpen" />
          </div>
        </div>
      </button>
