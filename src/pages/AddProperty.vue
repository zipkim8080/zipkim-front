      ...
      <form @submit.prevent="register">
        ...
        <div class="cover mb-3">
          ...
          <div>
            ...
            />
            <label class="form-check-label me-2" for="opi"> 오피스텔 </label>
            <input
              class="form-check-input me-5"
              type="radio"
              name="type"
              ...
              v-model="property.type"
            />
            <label class="form-check-label me-2" for="dd"> 단독다가구 </label>
            <input
              class="form-check-input me-5"
              type="radio"
              name="type"
              ...
              v-model="property.type"
            />
            <label class="form-check-label me-2" for="yr"> 연립다세대 </label>
            <input
