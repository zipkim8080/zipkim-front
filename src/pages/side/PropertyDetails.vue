      ...
      <div class="mt-2 mx-auto" style="height: 500px; width: 1300px">
        <div class="info-container">
          ...
          <div class="right-left">
            <!-- <img
            src=https://zipkim-bucket.s3.ap-northeast-2.amazonaws.com/2142f267-9403-4fcc-85cf-b4fe67a471cd.png
            /> -->
            <img
              src="https://zipkim-bucket.s3.ap-northeast-2.amazonaws.com/ed5020dc-6346-479b-9bbc-e09db06dbcd1.png"
            />
          </div>
        </div>
        <br />
