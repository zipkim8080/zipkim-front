...
const formattedOpenDate = computed(() => {
  if (!ocrData.openDate) return '';
  const openDate = ocrData.openDate;
  ...
  <div v-if="ocrData" class="modal-backdrop">
    <div class="result-container">
      <div class="mt-5 mx-auto" style="height: 80%; width: 500px">
        <div>
          <div class="fs-1 text-center" style="color: #955a1f">등기에서 확인된 내용이에요!</div>
          <br />
          <div>
          ...
          <div>
            열람일시: <strong>{{ formattedOpenDate }}</strong>
          </div>
          <br />
          ...
          >
            ...
            <div class="col">
              <p class="mb-0">
                ...
                <br />
                관리 편의를 위해 소유권을 신탁회사로 넘긴 것을 의미해요<br />신탁회사와 계약한다면
                문제 없어요
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="col">
              <p class="mb-0">
                <span class="fw-bold"
                  >전세권 {{ ocrData.leaseAmount.toLocaleString() }}원 발견!</span
                >
                <br />
            ...
            <div>
              ...
              <form>
                ...
                <input
                  ...
                  :value="rentalPrice ? rentalPrice.toLocaleString() : ''"
              ...
              <div v-if="price !== 0 && rentalPrice !== 0">
                ...
                <div v-else-if="result > 50 && result < 70">
                  ...
                  아직은 괜찮지만 근저당이 추가될 경우 위험성이 증가될 수 있어요
                </div>
                <div v-else>
      ...
      <!-- 닫기 버튼 -->
      <button @click="$emit('close')" class="kb_btn m-4" style="width: 550px">
        <strong>확인했어요!</strong>
      </button>
    </div>
  </div>
