...
const result = computed(() => {
  ...
  return Math.floor(((rentalPrice.value + realLoan.value) / price.value) * 100);
});
    ...
    <div class="result-container">
      <div class="mt-5 mx-auto" style="width: 500px">
        <div>
          ...
          >
            <div>
              <h4 class="text-center">이 집의 등기는 깨끗해요!</h4>
              <h6 class="text-center">우리 '집킴이'는 다음 내용들을 검사해요</h6>
              <br />
              <div
            ...
            <div class="text-center p-4">
              <p>해당 등기에서는 위의 항목과 관련된 내용이 없어요!</p>
            </div>
          </div>

          <!-- 압류 내역 -->
          <div
            v-if="ocrData.attachment1 === true && ocrData.auction !== true"
            class="row align-items-center p-3 rounded-start-5 rounded-end-5 mb-2"
            style="background-color: #f4f4f4"
          >
            <div class="col-auto">
            ...
            <div class="col">
              <p class="mb-0">
                <span class="fw-bold">압류 내역 발견!</span> <br />
                채무자의 재산이 밧줄로 꽁꽁 묶인 상태를 의미해요<br />경매에 넘어가기 직전이라
                <u>계약을 피하는게 안전해요</u>
              </p>
            </div>
          </div>
          ...
          <!-- 가압류 내역 -->
          <div
            v-if="ocrData.attachment2 === true && ocrData.auction !== true"
            class="row align-items-center p-3 rounded-start-5 rounded-end-5 mb-2"
            style="background-color: #f4f4f4"
          >
            <div class="col-auto">
            ...
            <div class="col">
              <p class="mb-0">
                ...
                <br />
                채무자의 재산이 임시적으로 묶인 상태를 의미해요<br />경매로 넘어갈 수 있어
                <u>계약을 피하는게 안전해요</u>
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="col">
              <p class="mb-0">
                <span class="fw-bold">신탁 내역 발견!</span> <br />
                관리의 편의를 위해 소유권을 신탁회사로 넘긴 것을 의미해요<br />신탁회사와 계약한다면
                문제 없어요
              </p>
            </div>
          </div>
          ...
          >
            <div class="col-auto">
              <div class="rounded-circle overflow-hidden" style="width: 70px; height: 70px">
                <img src="../../assets/images/auction.png" alt="경매" class="img-fluid" />
              </div>
            </div>
            <div class="col">
              <p class="mb-0">
                <span class="fw-bold">경매개시결정 내역 발견!</span>
                <br />
                경매를 진행한다는 것을 의미해요<br /><u>계약 자체를 고려하지 않는 것이 안전해요</u>
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="col">
              <p class="mb-0">
                <span class="fw-bold">전세권 {{ ocrData.leaseAmount }}원 발견!</span>
                <br />
                보증금을 지키기위해 설정하는 권리를 의미해요
                <br />계약시 <u>전세권 말소 조건</u>을 확인해야해요
              </p>
            </div>
          </div>
          ...
          >
            <div class="col-auto">
              <div class="rounded-circle overflow-hidden" style="width: 70px; height: 70px">
                <img src="../../assets/images/loan.png" alt="경매" class="img-fluid" />
              </div>
            </div>
            <div class="col">
              <p class="mb-0">
                <span class="fw-bold"
                  >근저당액 {{ parseInt(ocrData.loan).toLocaleString() }} 원 발견!</span
                >
                <br />
                이 집을 담보로 대출을 받은 금액을 의미해요<br />
                <u>근저당액을 고려한 매매가 대비 전세가</u>를 확인해야해요
              </p>
            </div>

            <div>
              <br /><br />
              <strong> 근저당액이 안전한지 확인해봐요!</strong><br />
              <span style="color: red">정확한 계산을 위해 근저당액의 77%를 적용했어요</span
              ><br /><br />

              <form>
                이 집 매매가는
                <input type="text" placeholder="매매가" v-model.number="price" />
                원 이에요. <br />
                제시된 전세가는
                <input type="text" placeholder="예상되는 전세가" v-model.number="rentalPrice" />
                원 이에요.
              </form>
              <hr />
